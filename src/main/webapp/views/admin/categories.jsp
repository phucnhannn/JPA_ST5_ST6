...
<table align="center" width="95%" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
    <td>
      <h2>Danh mục của tôi (Admin)</h2>
      <p>Xin chào, <c:out value="${currentUser.fullName != null ? currentUser.fullName : currentUser.username}"/>. Chỉ được sửa/xóa danh mục do bạn tạo.</p>
                        ...
                        <tr>
                          ...
                          <td>
                            <c:if test="${currentUser != null && item.owner != null && currentUser.userId == item.owner.userId}">
                              ...
                              &nbsp;|&nbsp;
                              <a href="${pageContext.request.contextPath}/admin/category/delete?id=${item.cateid}" onclick="return confirm('Xóa danh mục này?')">Xóa</a>
                            </c:if>
                          </td>
                        </tr>
                      </c:forEach>
            ...
            <table width="100%" cellpadding="10" cellspacing="0" border="1" bordercolor="#c8e6c9">
              ...
              <tr>
                <td>
                  ...
                  <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}<c:out value='${isEdit ? "/admin/category/update" : "/admin/category/create"}'/>">
                    <c:if test="${isEdit}">
                        ...
                        <td align="center">
                          <table cellpadding="8" cellspacing="0" border="0">
                            <tr>
                              ...
                              <c:if test="${isEdit}">
                                <td><a href="${pageContext.request.contextPath}/admin/category">Hủy</a></td>
                              </c:if>
                            </tr>
                          </table>
                        </td>
